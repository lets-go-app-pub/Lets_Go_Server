...
class RequestCategoriesTesting : public ::testing::Test {
protected:
...
TEST_F(RequestCategoriesTesting, invalidLoginInfo) {
...
TEST_F(RequestCategoriesTesting, successful) {
    runFunction();

    request_fields::CategoriesResponse generated_response;
