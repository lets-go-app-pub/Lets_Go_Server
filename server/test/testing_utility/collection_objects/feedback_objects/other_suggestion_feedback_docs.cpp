...
void OtherSuggestionFeedbackDoc::generateRandomValues(bool random_marked_by_spam) {
...
//converts this OtherSuggestionFeedbackDoc object to a document and saves it to the passed builder
void OtherSuggestionFeedbackDoc::convertToDocument(bsoncxx::builder::stream::document& document_result) const {

    document_result
        << other_suggestion_feedback_keys::ACCOUNT_OID << account_oid
        << other_suggestion_feedback_keys::MESSAGE << message
        << other_suggestion_feedback_keys::TIMESTAMP_STORED << timestamp_stored;

    if(marked_as_spam) {
        document_result
                << other_suggestion_feedback_keys::MARKED_AS_SPAM << *marked_as_spam;
    }
...
bool OtherSuggestionFeedbackDoc::setIntoCollection() {
    ...
    try {
        ...
        if (current_object_oid.to_string() != "000000000000000000000000") {
            ...
            other_suggestion_feedback_collection.update_one(
                    document{}
                    << "_id" << current_object_oid
                    << finalize,
                    document{}
            ...
            auto idVar = other_suggestion_feedback_collection.insert_one(insertDocument.view());
        ...
        << "bsoncxx EXCEPTION THROWN in OtherSuggestionFeedbackDoc::setIntoCollection\n"
        << e.what() << '\n'
        ...
        std::cout << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n"
        << "mongocxx EXCEPTION THROWN in OtherSuggestionFeedbackDoc::setIntoCollection\n"
        << e.what() << '\n'
        << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n";
        return false;
    }
...
bool OtherSuggestionFeedbackDoc::getFromCollection() {
    return getFromCollection(document{} << finalize);
}

bool OtherSuggestionFeedbackDoc::getFromCollection(const bsoncxx::oid& find_oid) {
...
bool OtherSuggestionFeedbackDoc::getFromCollection(const bsoncxx::document::view& find_doc) {
    mongocxx::pool::entry mongocxx_pool_entry = mongocxx_client_pool.acquire();
    mongocxx::client& mongo_cpp_client = *mongocxx_pool_entry;
    ...
    try {
        findDocumentVal = other_suggestion_feedback_collection.find_one(find_doc);
    }
    catch (const bsoncxx::exception& e) {
        std::cout << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n"
        << "bsoncxx EXCEPTION THROWN in OtherSuggestionFeedbackDoc::getFromCollection\n"
        << e.what() << '\n'
        << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n";
        return false;
    }
        ...
        std::cout << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n"
        << "mongocxx EXCEPTION THROWN in OtherSuggestionFeedbackDoc::getFromCollection\n"
        << e.what() << '\n'
        << "EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE\n";
        return false;
    }
...
bool OtherSuggestionFeedbackDoc::saveInfoToDocument(
    ...
    if (find_document_val) {
        ...
        //std::cout << "ERROR, Document not found from function OtherSuggestionFeedbackDoc::saveInfoToDocument\n";
        return false;
    }
}

bool
OtherSuggestionFeedbackDoc::convertDocumentToClass(const bsoncxx::v_noabi::document::view& user_account_document) {
    try {
        ...
        account_oid = extractFromBsoncxx_k_oid(
                user_account_document,
                other_suggestion_feedback_keys::ACCOUNT_OID
                );

        message = extractFromBsoncxx_k_utf8(
                user_account_document,
                other_suggestion_feedback_keys::MESSAGE
                );

        timestamp_stored = extractFromBsoncxx_k_date(
                user_account_document,
                other_suggestion_feedback_keys::TIMESTAMP_STORED
                );

        auto element = user_account_document[other_suggestion_feedback_keys::MARKED_AS_SPAM];
        if (element && element.type() == bsoncxx::type::k_utf8) { //if element exists and is type utf8
            ...
            logElementError(__LINE__, __FILE__, element,
                            user_account_document, bsoncxx::type::k_utf8, other_suggestion_feedback_keys::MARKED_AS_SPAM,
                            database_names::ACCOUNTS_DATABASE_NAME, collection_names::USER_ACCOUNTS_COLLECTION_NAME);

            throw ErrorExtractingFromBsoncxx("Error requesting user info value " + other_suggestion_feedback_keys::MARKED_AS_SPAM + ".");
        }
    }
...
bool OtherSuggestionFeedbackDoc::operator==(const OtherSuggestionFeedbackDoc& other) const {
...
std::ostream& operator<<(std::ostream& o, const OtherSuggestionFeedbackDoc& v) {
