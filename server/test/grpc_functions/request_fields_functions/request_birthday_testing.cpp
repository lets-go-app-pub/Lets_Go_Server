...
class RequestBirthdayTesting : public testing::Test {
protected:
...
TEST_F(RequestBirthdayTesting, invalidLoginInfo) {
...
TEST_F(RequestBirthdayTesting, successful) {
    runFunction();

    request_fields::BirthdayResponse generated_response;
    ...
    generated_response.mutable_birthday_info()->set_birth_year(user_account.birth_year);
    generated_response.mutable_birthday_info()->set_birth_month(user_account.birth_month);
    generated_response.mutable_birthday_info()->set_birth_day_of_month(user_account.birth_day_of_month);
    generated_response.mutable_birthday_info()->set_age(user_account.age);
