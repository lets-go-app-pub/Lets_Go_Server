...
grpc_chat_commands::ClientMessageToServerRequest setupClientEditedMessageRequest(
    ...
    message_specifics->mutable_edited_message()->set_new_message(edited_message_text);
    message_specifics->mutable_edited_message()->set_message_uuid(edited_message_uuid);
