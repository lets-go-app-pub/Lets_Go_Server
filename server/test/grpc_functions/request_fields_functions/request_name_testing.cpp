...
class RequestNameTesting : public ::testing::Test {
protected:
...
TEST_F(RequestNameTesting, invalidLoginInfo) {
...
TEST_F(RequestNameTesting, successful) {
    runFunction();
    ...
    generated_response.set_return_string(user_account.first_name);
