...
class RequestEmailTesting : public ::testing::Test {
protected:
...
TEST_F(RequestEmailTesting, invalidLoginInfo) {
...
TEST_F(RequestEmailTesting, successful) {
    runFunction();

    request_fields::EmailResponse generated_response;
    ...
    generated_response.mutable_email_info()->set_email(user_account.email_address);
    generated_response.mutable_email_info()->set_requires_email_verification(user_account.email_address_requires_verification);
